            ...
            return this.each(function() {
                ...
                if (settings.defaultValue != 0) {
                    ...
                    if (settings.callback != null)
                        settings.callback(element,settings.defaultValue);
                }
                ltracker.mousedown(function(e) {
					...
					/** ALTERED BY Marshall...
					* prevent selection of text while sliding
					*/
                ...
                function setTrackerPosition(cursorPosition) {
                    ...
                    if (cursorPosition >= sliderLeft && cursorPosition <= (sliderRight)) {
                        ...
                        if (trackerPosition >= 0 && trackerPosition <= (settings.sliderWidth)) {
                            ...
                            currentValue = parseInt(cVal,10);
							/** ALTERED BY Marshall
							* Causes issues for last 2 values of slider...quick change from second to last val to last val
                            if (trackerPosition > (settings.sliderWidth - stepValue) + stepValue / 10) {
								settings.sliderWidth / stepValue
                                currentValue = parseInt(settings.sliderWidth / stepValue);
                            }
							*/
							
                            if (settings.callback != null)
                                settings.callback(element,currentValue);
                        }
