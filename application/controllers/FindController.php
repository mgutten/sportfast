...
class FindController extends Zend_Controller_Action
{
	...
	public function gamesAction()
    {
		...
		$this->view->lookingFor = $dropdown->dropdown('looking-for', array('Games','Teams','Players'), 'Games');
    ...
    {
		$dropdown = Zend_Controller_Action_HelperBroker::getStaticHelper('Dropdown');
		$this->view->lookingFor = $dropdown->dropdown('looking-for', array('Games','Teams','Players'), 'Teams');
