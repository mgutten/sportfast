...
$(function() {
	...
	$('.member-schedule-day-container').click(function()
	{
		...
		if (!isMobile()) {
			// Not mobile browser, show full day text
	...
	/* trigger initial click of schedule-day to run above function */
	$('.member-schedule-day-container.light-back').trigger('click');
...
{		
	...
	if (typeof markerArray == 'undefined') {
		if (typeof gmapMarkers == 'undefined') {
			return false;
		}
