...
var titleInterval;
var confirmAction;
var mobile; // Global var to tell if browser is mobile or not
...
function populateNewNotifications(data)
{
	if (data[0] < 1) {
		...
		var currentNum = $('.nav-notification-indicator').first().text();
		currentNum = (currentNum == '' ? 0 : parseInt(currentNum, 10));
		var newNum = currentNum + parseInt(data[0], 10);
...
/**
 * test if browser is mobile (smartphone) and set global var
 */
function testMobile() {
...
/**
 * test if browser is mobile (smartphone)
 */
function isMobile() {
